...
#define __PLUGIN_ADJUSTMENT_SCREEN_NINTENDO_USE_LOW_POWER_ACTOR (0)
...
#define __PLUGIN_ADJUSTMENT_SCREEN_NINTENDO_LOW_POWER_ACTOR_X_POSITION (-152)
#define __PLUGIN_ADJUSTMENT_SCREEN_NINTENDO_LOW_POWER_ACTOR_Y_POSITION (-100)
#define __PLUGIN_ADJUSTMENT_SCREEN_NINTENDO_LOW_POWER_ACTOR_Z_POSITION (0)
